...
export default function Item({itemObj, onSelect }) {
    return(
        <div className="ml-5 w-full">
            <button onClick={() => onSelect(itemObj.name)} className= "flex justify-between w-full rounded-md p-2 mt-6 border-indigo-200 bg-zinc-800 transition-colors duration-400 hover:bg-indigo-600 hover:bg-opacity-50 hover:text-amber-500 cursor-pointer">
